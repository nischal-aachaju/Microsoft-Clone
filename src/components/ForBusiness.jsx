...
const ForBusiness = () => {
    ...
    const items = [
        ...
        {
            img: "/src/assets/images/Content-Card-Microsoft-365-Copilot-COMMR-0625.avif",
        ...
        {
            img: "/src/assets/images/Content-Card-Windows-11-Business.avif",
        ...
        {
            img: "/src/assets/images/Content-Card-Azure-AI-Bloom.avif",
